...
const crearProducto= async (req,res)=>{
    const {name,precio,url_img,cantidad}=req.body;//extrae los datos que enviamos desde el front
...
module.exports= {crearProducto,editarProducto,eliminarProducto,cargarProducto,cargarUsuarios,cargarPedidos,confirmarPedido,inhabilitarUsuario};